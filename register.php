                ...
                <div class="body-container">
                    <div class="account">
                        ...
                        <div class="form-register">
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                <div class="form-register__register-form">
                                    <div class="form-register__username">
                                        ...
                                        <input type="text" placeholder="Nhập số điện thoại hoặc email" name="user_register">
                                    </div>
                                    <div class="form-register__password">
                                        <p>Mật khẩu</p>
                                        <input type="password" placeholder="Nhập mật khẩu" name="pass_register">
                                    </div>
                                    <div class="form-register__password">
                                        <p>Xác Nhận Mật khẩu</p>
                                        <input type="password" placeholder="Xác nhận mật khẩu" name="pass_confirm_register">
                                    </div>
                            ...
                            <?php
                            $userRegister = $passRegister = $passConfirm = "";
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                if (isset($_POST['user_register']) || isset($_POST['pass_register']) || isset($_POST['pass_confirm_register'])) {
                                    $userRegister = $_POST['user_register'];
                                    $passRegister = $_POST['pass_register'];
                                    $passConfirm = $_POST['pass_confirm_register'];
                                }
                                if (empty($userRegister) == 1 || empty($passRegister) == 1 || empty($passConfirm) == 1) {
                                    echo "<script type='text/javascript'>alert('Tài khoản hoặc mật khẩu không được để trống!');</script>";
                                } elseif (strcmp($passRegister, $passConfirm) != 0) {
                                    echo "<script type='text/javascript'>alert('Mật khẩu và Xác nhận mật khẩu phải trùng khớp với nhau!');</script>";
                                } else {
                                    ...
                                    $sqlSelect = "SELECT username FROM account WHERE username = '".$userRegister."'";
                                    $sqlInsert = "INSERT INTO account (username, password) VALUES ('".$userRegister."', '".$passRegister."')";
